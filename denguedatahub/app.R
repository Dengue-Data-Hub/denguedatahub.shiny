...
server <- function(input, output) {
  ...
  output$mytable1 <- DT::renderDataTable({
    DT::datatable(level_of_risk, extensions = "Buttons", options = list(orderClasses = TRUE, iDisplayLength = 30,
                                                                        paging = TRUE,
                                                                        scrollX=TRUE, 
                                                                        searching = TRUE,
                                                                        ordering = TRUE,
  ...
  output$mytable2 <- DT::renderDataTable({
    DT::datatable(srilanka_weekly_data, extensions = "Buttons", options = list(orderClasses = TRUE, iDisplayLength = 30,
                                                                               paging = TRUE,
                                                                               scrollX=TRUE, 
                                                                               searching = TRUE,
                                                                               ordering = TRUE,
  ...
  output$mytable3 <- DT::renderDataTable({
    DT::datatable(world_annual, extensions = "Buttons", options = list(orderClasses = TRUE, iDisplayLength = 30,
                                                                       paging = TRUE,
                                                                       scrollX=TRUE, 
                                                                       searching = TRUE,
                                                                       ordering = TRUE,
 ...
 #  customize the length drop-down menu; display 5 rows per page by default
  output$mytable4 <- DT::renderDataTable({
    DT::datatable(singapore_weekly_data, extensions = "Buttons", options = list(orderClasses = TRUE, iDisplayLength = 30,
                                                                                paging = TRUE,
                                                                                scrollX=TRUE, 
                                                                                searching = TRUE,
                                                                                ordering = TRUE,
  ...
  output$mytable5 <- DT::renderDataTable({
    DT::datatable(china_annual_data, extensions = "Buttons", options = list(orderClasses = TRUE, iDisplayLength = 30,
                                                                            paging = TRUE,
                                                                            scrollX=TRUE, 
                                                                            searching = TRUE,
                                                                            ordering = TRUE,
